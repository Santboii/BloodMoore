...
export class LobbyUI {
  ...
  showHome(username?: string, points?: number, charClass?: string, level?: number): void {
    ...
    const amazonBowSvg = `<svg viewBox="0 0 32 32" width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 3 C2 10 2 22 10 29" stroke="#c8a870" stroke-width="2" stroke-linecap="round" fill="none"/><line x1="10" y1="3" x2="10" y2="29" stroke="#a08040" stroke-width="1" opacity="0.7"/><line x1="10" y1="16" x2="28" y2="8" stroke="#e8d8b0" stroke-width="1.8" stroke-linecap="round"/><polygon points="29,7 24,7.5 27,11" fill="#c8a870"/><line x1="26" y1="9" x2="28" y2="5" stroke="#c8a870" stroke-width="0.8" stroke-linecap="round"/><line x1="26" y1="9" x2="30" y2="7" stroke="#c8a870" stroke-width="0.8" stroke-linecap="round"/></svg>`;
