...
export class LobbyUI {
  ...
  showHome(username?: string, points?: number, charClass?: string, level?: number): void {
    ...
    const amazonBowSvg = `<svg viewBox="0 0 32 32" width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 4 C28 8 28 24 22 28" stroke="#8b5e2b" stroke-width="2.2" stroke-linecap="round" fill="none"/><line x1="22" y1="4" x2="22" y2="28" stroke="#c8a870" stroke-width="0.9"/><line x1="22" y1="16" x2="6" y2="16" stroke="#d4b896" stroke-width="1.6" stroke-linecap="round"/><polygon points="5,16 9,14 9,18" fill="#8b5e2b"/></svg>`;
