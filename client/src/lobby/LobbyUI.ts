...
export class LobbyUI {
  ...
  showHome(username?: string, points?: number, charClass?: string, level?: number): void {
    ...
    const mageStaffSvg = `<svg viewBox="0 0 32 32" width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg"><line x1="16" y1="6" x2="16" y2="30" stroke="#8b6cc4" stroke-width="2.5" stroke-linecap="round"/><circle cx="16" cy="5" r="3.5" fill="#6b3fa0" stroke="#a478e8" stroke-width="1.2"/><circle cx="16" cy="5" r="1.5" fill="#d4b0ff"/><line x1="14" y1="5" x2="12" y2="3" stroke="#a478e8" stroke-width="1" stroke-linecap="round"/><line x1="18" y1="5" x2="20" y2="3" stroke="#a478e8" stroke-width="1" stroke-linecap="round"/><line x1="16" y1="3" x2="16" y2="1" stroke="#a478e8" stroke-width="1" stroke-linecap="round"/></svg>`;
    const amazonBowSvg = `<svg viewBox="0 0 32 32" width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6 26 C2 18 10 4 22 2" stroke="#c8a870" stroke-width="2.2" stroke-linecap="round" fill="none"/><line x1="6" y1="26" x2="22" y2="2" stroke="#a08040" stroke-width="1"/><line x1="24" y1="2" x2="4" y2="28" stroke="#d4b896" stroke-width="1.8" stroke-linecap="round"/><polygon points="3,29 5,25 7,27" fill="#c8a870"/><polygon points="25,1 23,5 21,3" fill="#c8a870"/></svg>`;
