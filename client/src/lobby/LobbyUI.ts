...
export class LobbyUI {
  ...
  showHome(username?: string, points?: number, charClass?: string, level?: number): void {
    ...
    const amazonBowSvg = `<svg viewBox="0 0 32 32" width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M24 3 C30 10 30 22 24 29" stroke="#8b5e2b" stroke-width="2.2" stroke-linecap="round" fill="none"/><path d="M24 3 Q12 16 24 29" stroke="#c8a870" stroke-width="0.9" fill="none"/><line x1="12" y1="16" x2="4" y2="16" stroke="#d4b896" stroke-width="1.6" stroke-linecap="round"/><polygon points="3,16 7,14.2 7,17.8" fill="#8b5e2b"/></svg>`;
