...
const CLASS_ICONS: Record<string, string> = {
  ...
  amazon: `<svg viewBox="0 0 32 32" width="18" height="18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6 26 C2 18 10 4 22 2" stroke="#c8a870" stroke-width="2.2" stroke-linecap="round" fill="none"/><line x1="6" y1="26" x2="22" y2="2" stroke="#a08040" stroke-width="1"/><line x1="24" y1="2" x2="4" y2="28" stroke="#d4b896" stroke-width="1.8" stroke-linecap="round"/><polygon points="3,29 5,25 7,27" fill="#c8a870"/><polygon points="25,1 23,5 21,3" fill="#c8a870"/></svg>`,
};
